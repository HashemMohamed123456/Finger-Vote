...
class FingerprintScreenSix extends StatelessWidget {
  const FingerprintScreenSix({super.key});
        ...
        children: [
          ...
          Padding(
            ...
            crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Center(child: Text('Mohamed Atef',style:TextStyle(color: AppColors.blue,fontSize: 25,fontWeight: FontWeight.w800))),
                 SizedBox(height: 20,),
                Center(
                  child: ClipOval(

                    child: Image.network('https://img.freepik.com/premium-photo/handsome-young-man-formalwear-looking-camera-adjusting-tie-while-standing-against-grey-background_425904-39648.jpg',fit: BoxFit.fill,width:200,height:200,),
                  ),
                ),
                SizedBox(height: 10,),
