...
class FingerprintScreenThree extends StatelessWidget {
  const FingerprintScreenThree({super.key});
        ...
        children: [
          ...
          Padding(
            ...
            crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Center(child: Text('Hashem Mohamed',style:TextStyle(color: AppColors.blue,fontSize: 25,fontWeight: FontWeight.w800))),
                 SizedBox(height: 20,),
                Center(
                  child: ClipOval(

                    child: Image.network('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTYHJXdJcwVncUZani0-WBXCckW41aVtyNsvncOdFDG4C59TV7fihv4sbIK2MXF1uTtBzc&usqp=CAU',fit: BoxFit.fill,width:200,height:200,),
                  ),
                ),
                SizedBox(height: 10,),
