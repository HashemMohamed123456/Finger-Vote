...
class FingerprintScreenFour extends StatelessWidget {
  const FingerprintScreenFour({super.key});
        ...
        children: [
          ...
          Padding(
            ...
            crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Center(child: Text('Taha Hany',style:TextStyle(color: AppColors.blue,fontSize: 25,fontWeight: FontWeight.w800))),
                 SizedBox(height: 20,),
                Center(
                  child: ClipOval(

                    child: Image.network('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQUKIRFfmGckUtXkjCqNLrMt5AouJI5t9p8xW3Gx2u45wMBvIGWtRs_nEn0aS7mOzm8v2o&usqp=CAU',fit: BoxFit.fill,width:200,height:200,),
                  ),
                ),
                SizedBox(height: 10,),
