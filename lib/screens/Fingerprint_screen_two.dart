...
class FingerprintScreenTwo extends StatelessWidget {
  const FingerprintScreenTwo({super.key});
        ...
        children: [
          ...
          Padding(
            ...
            crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Center(child: Text('Ahmed Gamal',style:TextStyle(color: AppColors.blue,fontSize: 25,fontWeight: FontWeight.w800))),
                 SizedBox(height: 20,),
                Center(
                  child: ClipOval(

                    child: Image.network('https://img.freepik.com/free-photo/portrait-expressive-young-man-wearing-formal-suit_273609-6942.jpg?size=626&ext=jpg&ga=GA1.1.1546980028.1704412800&semt=ais',fit: BoxFit.fill,width:200,height:200,),
                  ),
                ),
                SizedBox(height: 10,),
